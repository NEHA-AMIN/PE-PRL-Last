#!/bin/bash
# =============================================================================
# Formula A (Positional Space) — Phase 2: Consecutive Legendre Delta Ordering
#
...
LOG_DIR="$PROJECT_ROOT/logs/Formula-A-pos-phase2"
...
{
echo "============================================================"
echo " Formula A (Positional Space) — Phase 2: Legendre Consecutive Delta"
echo " Date: $(date)"
echo "------------------------------------------------------------"
...
for pred_len in 48 96 192 336; do
    ...
    TOTAL=$((TOTAL + 1))
    RUN_ID="formula_a_pos_ph2_ETTh1_pred${pred_len}_seed${seed}"
...
# --- SUMMARY ---
echo "============================================================" | tee -a "$MASTER_LOG"
echo " PHASE 2 SUMMARY — Formula A (Positional Space)"            | tee -a "$MASTER_LOG"
