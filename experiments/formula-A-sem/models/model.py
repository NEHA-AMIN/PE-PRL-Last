...
from models.embed import DataEmbedding, DataEmbedding_delta_pos
...
class Informer(nn.Module):
    def __init__(self, enc_in, dec_in, c_out, seq_len, label_len, out_len,
        ...
        if pe_mode == 'vanilla':
            ...
            self.enc_embedding = DataEmbedding_delta_pos(enc_in, d_model, embed, freq, dropout)
            self.dec_embedding = DataEmbedding_delta_pos(dec_in, d_model, embed, freq, dropout)
        else:
            raise ValueError(
                f"Unknown pe_mode '{pe_mode}'. "
                f"Expected 'vanilla' or 'delta_pos'."
            )
