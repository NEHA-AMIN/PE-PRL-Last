#!/bin/bash
# =============================================================================
# Formula B (Positional Space) — Phase 2: Global Mean Deviation Ordering
#
...
LOG_DIR="$PROJECT_ROOT/logs/Formula-B-pos-phase2"
...
{
echo "============================================================"
echo " Formula B (Positional Space) — Phase 2: Legendre Global Mean Deviation"
echo " Date: $(date)"
echo "------------------------------------------------------------"
...
for pred_len in 48 96 192 336; do
    ...
    TOTAL=$((TOTAL + 1))
    RUN_ID="formula_b_pos_ph2_ETTh1_pred${pred_len}_seed${seed}"
...
# --- SUMMARY ---
echo "============================================================" | tee -a "$MASTER_LOG"
echo " PHASE 2 SUMMARY — Formula B (Positional Space)"            | tee -a "$MASTER_LOG"
